...
%  velocityModel = gaussian_smoother(velocityModel,x,z,20);
 
%rsf_write(rho,'rho.rsf');
%unix('< rho.rsf sfgrey | sfpen')
...
% ind_angle = (0:80)/180*pi;
% for i_ang = 1:81;
%     rpp(i_ang) = reflection_coef(1800,2600,ind_angle(i_ang));
% end
% figure;plot(ind_angle*180/pi,rpp),
%% Migration
